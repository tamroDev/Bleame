...
const userReport = [
    {
        ...
        contentReport: "I'm totally blown away. Ingrown hair and the skin irritation was the bane of my life for many years. Bleame has changed the way my skin looks forever!",
        nameAuthor: "Sarah F.",
        avatarAuthor: "/assets/images/author_1.webp",
    },
    {
        imgReport: "/assets/images/report-2.webp",
        contentReport: "I have struggled with strawberry leg for years and waxing just wasn't cutting it, Bleame has really made a huge difference in my life and has given me so much confidence!",
        nameAuthor: "Mariah B.",
        avatarAuthor: "/assets/images/author_2.webp",
    },
    {
        imgReport: "/assets/images/report-3.webp",
        contentReport: "It works great. I've used on my husband's body hair and surprisingly it cleans them up lol. Thank you for inventing this. Super exciting.",
        nameAuthor: "Susan T.",
        avatarAuthor: "/assets/images/author_3.webp",
    },
];
document.addEventListener("DOMContentLoaded", () => {
    const listReport = document.querySelector(".list_user_report");
    if (!listReport)
        return;
    userReport.forEach((itReport) => {
        const divItemReport = document.createElement("div");
